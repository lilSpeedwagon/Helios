...
#include "../../Light_System_prototype/requestmanager.h"
...
QT_MOC_LITERAL(1, 15, 17), // "signalProcessData"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 4), // "data"
QT_MOC_LITERAL(4, 39, 15), // "slotGetResponse"
QT_MOC_LITERAL(5, 55, 14), // "QNetworkReply*"
QT_MOC_LITERAL(6, 70, 5), // "reply"
QT_MOC_LITERAL(7, 76, 23) // "slotRequestForVideoData"

    },
    "RequestManager\0signalProcessData\0\0"
    "data\0slotGetResponse\0QNetworkReply*\0"
    "reply\0slotRequestForVideoData"
};
...
void RequestManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalProcessData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->slotGetResponse((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        case 2: _t->slotRequestForVideoData(); break;
        default: ;
        }
        ...
        {
            using _t = void (RequestManager::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RequestManager::signalProcessData)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject RequestManager::staticMetaObject = {
...
// SIGNAL 0
void RequestManager::signalProcessData(QString _t1)
{
