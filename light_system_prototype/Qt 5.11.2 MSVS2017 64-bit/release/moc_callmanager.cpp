...
#include "../../Light_System_prototype/callmanager.h"
...
QT_MOC_LITERAL(1, 12, 16), // "signalEndCalling"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 17), // "slotCancelCalling"
QT_MOC_LITERAL(4, 48, 15), // "slotGetResponse"
QT_MOC_LITERAL(5, 64, 14), // "QNetworkReply*"
QT_MOC_LITERAL(6, 79, 5) // "reply"

    },
    "CallManager\0signalEndCalling\0\0"
    "slotCancelCalling\0slotGetResponse\0"
...
void CallManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CallManager *_t = static_cast<CallManager *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->signalEndCalling(); break;
        case 1: _t->slotCancelCalling(); break;
        case 2: _t->slotGetResponse((*reinterpret_cast< QNetworkReply*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CallManager::signalEndCalling)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CallManager::staticMetaObject = {
    { &RequestManager::staticMetaObject, qt_meta_stringdata_CallManager.data,
      qt_meta_data_CallManager,  qt_static_metacall, nullptr, nullptr}
};
...
void *CallManager::qt_metacast(const char *_clname)
{
    ...
    return RequestManager::qt_metacast(_clname);
}

int CallManager::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = RequestManager::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 3)
