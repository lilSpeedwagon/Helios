...
#include "../../Light_System_prototype/map.h"
...
QT_MOC_LITERAL(1, 4, 15), // "slotProcessData"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4) // "data"

    },
    "Map\0slotProcessData\0\0data"
};
...
void Map::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotProcessData((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
